package net.valet.helper

import android.content.Context
import android.content.SharedPreferences


class SessionManagerApps(var c: Context) {
    var pref: SharedPreferences
    var editor: SharedPreferences.Editor
    var PRIVATE_MODE = 0

    //0 agar cuma bsa dibaca hp itu sendiri
    var PREF_NAME = "AdmissionAppPrefApps"
    ...
    var apiServer: String
        ...
        get() = pref.getString("apiServerApps", "http://192.168.0.106:8080/api-valet/public").toString()
        set(apiServer) {
