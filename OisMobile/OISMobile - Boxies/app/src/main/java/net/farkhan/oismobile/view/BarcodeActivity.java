        ...
        public void onPreviewFrame(byte[] data, Camera camera) {
            ...
            if (result != 0) {
                ...
                for (Symbol sym : syms) {
                    ...
                    Toast.makeText(BarcodeActivity.this, "Checking ID Transaction " + scanResult, Toast.LENGTH_LONG).show();
